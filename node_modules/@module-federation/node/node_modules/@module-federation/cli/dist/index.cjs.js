...
function runCli(options) {
    const normalizedOptions = Object.assign({ loggerPrefix: PREFIX, welcomeMsg: `${`Module Federation v${"0.23.0"}`}\n`, name: 'mf', readConfig, version: "0.23.0", applyCommands: () => { } }, options);
